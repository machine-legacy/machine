...
namespace Machine.Container.Services.Impl
{
  ...
  public class ThrowsPendingActivatorResolverTests : ScaffoldTests<ThrowsPendingActivatorResolver>
  {
    ...
    public void ResolveActivator_Always_Throws()
    {
      ...
      ICreationServices creationServices = new CreationServices(Get<IActivatorStrategy>(), Get<IActivatorStore>(), Get<ILifestyleFactory>(), Get<IOverrideLookup>(), Get<IServiceEntryResolver>());
